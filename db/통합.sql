...
INSERT INTO crew (
  ...
  img_name, leader_nickname, leader_id, grade, sche_check
)
VALUES
('한강 라이더스', '서울', '초급', 10, '매달 첫째주 토요일', '자전거를 시작하게 된 계기와 주로 타는 요일은?', 5, 'default.png', 'name02', 'user02', '브론즈', 'regular'),
('부산 해안질주단', '부산', '중급', 12, '매주 일요일 오전', '바다 근처 라이딩을 좋아하시나요? 그 이유는?', 4, 'default.png', 'name03', 'user03', '실버', 'regular'),
('대전 업힐러즈', '대전', '고급', 8, '격주 토요일 새벽', '업힐 경험이 있으신가요? 어느 정도인가요?', 5, 'default.png', 'name04', 'user04', '골드', 'regular'),
('광주 슬로우라이더', '광주', '초급', 15, '번개', '속도보단 여유로운 라이딩을 좋아하시나요?', 3, 'default.png', 'name05', 'user05', '브론즈', 'one'),
('제주 오름러버스', '제주', '중급', 10, '매주 토요일 오전', '가장 좋아하는 오름이 어디인지 알려주세요!', 4, 'default.png', 'name06', 'user06', '실버', 'regular');
