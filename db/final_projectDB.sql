...
VALUES
    (1, '5월 첫 라이딩 일정', '5월 첫 주 라이딩은 반포 한강공원에서 시작합니다. 오전 9시 집결!',  'user02', '공지' ),
    (1, '초급자 라이딩 후기', '오늘 처음 라이딩 참여했는데 너무 재밌었어요! 다들 친절해서 감사했어요~',  'user07', '일반'),
    (1, '5월 두번째 주 일정', '이번 주는 아라뱃길 코스로 진행됩니다. 모두 헬멧 꼭 착용하세요!',  'user02', '공지'),
    (2, '해운대 야경 라이딩 후기', '해운대 야경 너무 예뻤어요. 밤바다 바라보며 달리는 기분 최고!',   'user08', '일반'),
    (2, '중급 코스 추가 제안', '다음엔 달맞이고개 코스 추가 어때요? 뷰도 좋고 도전 욕구 생겨요!',   'user03', '일반'),
    (2, '6월 라이딩 계획 공유', '6월은 거제도로 원정 라이딩 어때요? 의견 주세요~',   'user09', '공지'),
    (3, '고급 훈련 일정 안내', '계족산 다음은 무학산 업힐 훈련 예정입니다. 각오 단단히!',   'user04', '공지'),
    (3, '훈련 후 스트레칭 방법 공유', '업힐 후 무릎 보호 스트레칭 팁 공유해요~',   'user10', '일반'),
    (3, '고급자 모임 일정 조율', '다음 주 토요일이 좋을까요? 일요일이 좋을까요?',   'user11', '일반'),
    (4, '풍암호수공원 후기도 좋아요', '경치도 좋고 사람도 적어서 좋아요. 다음에도 또 가요!',   'user12', '일반'),
    (4, '초급자용 코스 추천해주세요', '풍암 외에도 다른 초급자 코스 있으면 공유 부탁드려요!',   'user05', '일반'),
    (4, '정기 모임 간식 준비', '이번 주 모임 간식 제가 준비해볼게요~ 과일 어때요?',   'user06', '일반'),
    (5, '성산 투어 사진 모음', '찍은 사진들 구글 드라이브에 업로드했습니다~',   'user02', '일반'),
    (5, '성산 투어 리마인드 공지', '출발 시간 다시 확인 부탁드려요. 오전 7시입니다!',   'user03', '공지'),
    (5, '성산 투어 장비 체크리스트', '라이딩 전 체크할 장비 리스트 공유합니다.',   'user04', '일반'),
    (1, '라이딩 후 식사 장소 추천', '근처 맛집 추천받아요~ 라이딩 후 고기?',   'user08', '일반'),
    (2, '라이딩 중 사고 예방 팁', '무리하지 말고 신호 준수 필수입니다!',   'user09', '일반'),
    (3, 'GPS 트래커 추천', '고급자용 GPS 기기 추천 받아요. 어떤 거 쓰세요?',   'user10', '일반'),
    (4, '풍암 모임 참가자 명단 공유', '현재까지 참가자 12명입니다. 변동 생기면 댓글로!',   'user11', '공지'),
    (5, '성산 투어 소감 나눔', '정말 즐거운 시간이었어요. 다음에도 또 함께해요!',   'user12', '일반');
